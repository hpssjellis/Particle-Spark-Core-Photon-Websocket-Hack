...
/*
        ...
        if (myRX < myGoodRX && myLX < myGoodRX && myRY < myGoodRY && myLY < myGoodRY) {   
            document.getElementById('myDirectionToGo').value = 'top left: go left, slower '   + ' rx:' + Math.round(myRX) + ', ly:' + Math.round(myLY)
            myShowSpot -= 10; 
           // ws.send('p');
            mySendNew = 'p'
        ...
        if (myRX <= myGoodRX && myLX < myGoodLX && myRY > myGoodRY && myLY < myGoodRY) {   
          document.getElementById('myDirectionToGo').value = 'Middle: go left, set speed ' + ' rx:' + Math.round(myRX) + ', ly:' + Math.round(myLY)
          myShowSpot = 50; 
          //ws.send('s');
            mySendNew = 's'
        } 
        ...
        if (myRX >= myGoodRX && myLX < myGoodLX && myRY > myGoodRY && myLY < myGoodRY) {   
          document.getElementById('myDirectionToGo').value = 'Left Middle: set turn, set speed ' + ' rx:' + Math.round(myRX) + ', ly:' + Math.round(myLY)
          myShowSpot = 50; 
          //ws.send('t');
            mySendNew = 't'
        } 
