...
//////////////////////////////////// start work here ///////////////////////////////////////////////////////        
        ...
        if (myRX < myGoodRX && myLX < myGoodRX && myRY < myGoodRY && myLY < myGoodRY) {   
            document.getElementById('myDirectionToGo').value = 'top left: go left, slower'    
            myShowSpot -= 10; 
            ws.send('p');
        } 
        
        if (myRX >= myGoodRX && myLX < myGoodLX && myRY > myGoodRY && myLY < myGoodRY) {   
          document.getElementById('myDirectionToGo').value = 'Middle: set turn, set speed'    
          myShowSpot = 50; 
          ws.send('t');
        } 
         ...
         if (myRX > myGoodRX && myLX > myGoodRX && myRY > myGoodRY && myLY > myGoodRY) {   
            document.getElementById('myDirectionToGo').value = 'bottom right: go right, faster'    
            myShowSpot += 10; 
            ws.send('x');
        } 
